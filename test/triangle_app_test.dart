...
import 'package:flutter_triangle_app/triangle_app.dart';
...
void main() {
  group('Detect the triangle', () {
    ...
    test('Should return "Segitiga Sama Kaki" when only two sides equal', () {
    ...
    test('Should return "Segitiga Sembarang" when only no sides are equal', () {
        expect(detectTriangle(6, 5, 4), "Segitiga Sembarang");
    });
  });
}
